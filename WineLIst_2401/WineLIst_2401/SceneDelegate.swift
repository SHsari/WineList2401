    ...
    func scene(_ scene: UIScene, willConnectTo session: UISceneSession, options connectionOptions: UIScene.ConnectionOptions) {
        ...
        if fileSelector.shouldFindNewFile(){
            ...
            if let wineVC = storyboard.instantiateViewController(withIdentifier: "wineViewController") as? WineViewController {
                ...
                wineVC.fileURL = fileSelector.selectedFileURL
                window.rootViewController = wineVC
                window.makeKeyAndVisible()
            }
        }
